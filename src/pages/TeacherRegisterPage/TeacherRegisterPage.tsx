...
import './TeacherRegisterPage.scss';
import logo from '../../assets/COSCI_logo.png';
import { useFormik } from 'formik';
import * as Yup from 'yup';
import { useDispatch, useSelector } from 'react-redux';
import { getTeacherUploadList } from '../../store/teacherUpload/selector';
import { fetchTeacherUploadList } from '../../store/teacherUpload/thunk';
import { PostTeacherUploadListRequest } from '../../service';
...
const RegisterPages: React.FC<any> = () => {
  ...
  const teacherUploadListData = useSelector(getTeacherUploadList);

  function UserFetch(id: PostTeacherUploadListRequest) {
    dispatch(fetchTeacherUploadList(id));
  }
